  ...
  const projects = [
    {
      ...
      images: [
        "/imagen/Veta/Captura de pantalla (5).png",
        "/imagen/Veta/Captura de pantalla (6).png",
        "/imagen/Veta/Captura de pantalla (7).png",
        "/imagen/Veta/Captura de pantalla (8).png",
        "/imagen/Veta/Captura de pantalla (9).png",
        "/imagen/Veta/Captura de pantalla (10).png",
      ],
    ...
    },
    {
      ...
      images: [
        "/imagen/Comercial/Captura de pantalla (17).png",
        "/imagen/Comercial/Captura de pantalla (18).png",
        "/imagen/Comercial/Captura de pantalla (20).png",
        "/imagen/Comercial/Captura de pantalla (21).png",
        "/imagen/Comercial/Captura de pantalla (22).png",
        "/imagen/Comercial/Captura de pantalla (23).png",
    ...
    },
    {
      ...
      images: [
        "/imagen/Gestion electrica/Captura de pantalla (1).png",
        "/imagen/Gestion electrica/Captura de pantalla (2).png",
        "/imagen/Gestion electrica/Captura de pantalla (3).png",
        "/imagen/Gestion electrica/Captura de pantalla (4).png",
      ],
      technologies: ["Django", "React", "PostgreSQL"],
      // demoUrl: "#",
    ...
    },
    {
      ...
      images: [
        "/imagen/EcoVidrio/Captura de pantalla (12).png",
        "/imagen/EcoVidrio/Captura de pantalla (13).png",
        "/imagen/EcoVidrio/Captura de pantalla (14).png",
        "/imagen/EcoVidrio/Captura de pantalla (15).png",
        "/imagen/EcoVidrio/Captura de pantalla (16).png",
      ],
